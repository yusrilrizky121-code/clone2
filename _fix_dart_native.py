...
print("✓ main.dart written, lines:", len(dart.split('\n')))
print("onMusicPlaying with videoId:", 'args[2]' in dart)
print("playNative call:", 'playNative' in dart)
print("progressTimer:", '_progressTimer' in dart)
print("_startProgressTimer:", '_startProgressTimer' in dart)
