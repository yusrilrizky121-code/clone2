...
# Verifikasi
c = open('auspoty-flutter/lib/main.dart', encoding='utf-8').read()
print('onMusicPlaying:', 'onMusicPlaying' in c)
print('onMusicPaused:', 'onMusicPaused' in c)
print('setBgMode:', 'setBgMode' in c)
print('_onNativeCall:', '_onNativeCall' in c)
print('onPlayPause:', 'onPlayPause' in c)
print('Lines:', c.count('\n'))
